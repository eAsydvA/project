...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
      <h1 className='text-3xl font-medium'>Наши врачи</h1>
      <p className='sm:w-1/3 text-center text-m'>Посмотрите список врачей.</p>
      ...
      <button onClick={()=>{navigate('/doctors'); scrollTo(0,0)}} className='bg-blue-100 text-gray-600 px-12 py-3 rounded-full mt-10'>Еще</button>
    </div>
  )
}
